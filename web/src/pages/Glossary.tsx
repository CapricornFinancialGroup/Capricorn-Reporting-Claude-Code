...
const CONCEPTS: Term[] = [
  ...
  { name: "Weekly Written (Revenue)", def: "Market Momentum's \"Revenue\" is written business, not commission (Kyle, 2026-07-14): Mortgage + Insurance written £, shown separately and combined, against the weekly written targets. Actuals come from the same Total Written report Capricorn uses, so the two reconcile. (Adviser League's \"Est. Revenue\" is separate — that's commission.)" },
