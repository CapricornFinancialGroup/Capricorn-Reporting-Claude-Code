...
const CONCEPTS: Term[] = [
  ...
  { name: "Weekly Written (Revenue)", def: "Market Momentum's \"Revenue\" is written business = written commission (Kyle, 2026-07-15): mortgage commission + client fees, which reconciles to Capricorn's own Total Written report. Protection written is pending confirmation of its source, and the target-vs-actual comparison is off until both tie out. \"Total Lending\" (loan value) is a separate figure — not the same as written." },
