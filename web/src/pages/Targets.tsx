...
// pledge) and Revenue (written commission). Leads is a fixed group target, set in config.
    ...
    <div className="screen">
      ...
      <div className="card">
        ...
        <div className="placeholder-note">
          ...
          Leads is a fixed group target and isn't set here. Anything with no data for the chosen week
          is left unchanged rather than zeroed.
        </div>
